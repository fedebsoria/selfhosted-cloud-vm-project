...
# Last we install cockpit for system management see the different distributions instructions at https://cockpit-project.org/running.html
. /etc/os-release
sudo apt install -t ${VERSION_CODENAME}-backports cockpit
# enable cockpit to start on boot
sudo systemctl enable --now cockpit.socket
# access cockpit web interface at https://<server_ip>:9090
# cockpit gives a nice overview of system resources and logs in the web browser.